...
C1_24K =[3, 2, 3, 3,2, 3, 4, 3, 4, 3];
C1_32K =[3, 4, 4, 3, 6, 4, 5, 4, 4, 4];
C1_40K =[7, 6, 6, 5, 6, 5, 6, 5, 8, 6]; 
C1_48K =[7, 8, 8, 8, 6, 7, 9, 11, 9, 8];
C1_56K =[10, 10, 10, 13, 10, 11, 8, 11, 10, 10 ];
...
hold on;
%第二实验数据
C1_16K =[4,3 ,4 ,4,3, 4, 5, 4, 5, 4 ]; %
C1_24K =[5, 4, 5 ,5 ,4 ,5, 5, 5 ,6,5 ];
C1_32K =[5, 6, 6, 5, 8 ,6, 7, 6, 5, 6];
C1_40K =[9, 8, 8, 7, 8, 7, 8, 7, 10, 8]; 
C1_48K =[9, 10, 10, 10, 8, 9 ,11 ,13 ,11, 10];
C1_56K =[8, 12, 12, 15, 12, 13, 10, 13, 12, 12 ];
...
hold on;
%第三组实验数据
C1_16K =[3, 2, 3 ,3, 2, 3, 4, 3 ,4, 3 ]; % case1,16k
C1_24K =[4, 3, 4 ,4, 3, 4, 4, 4, 5 ,4 ];
C1_32K =[4, 5, 5, 4, 7, 6, 6, 5, 4, 5];
C1_40K =[8, 7, 7, 6, 7, 6, 7, 6 ,9, 7]; 
C1_48K =[8, 9, 9, 9, 7, 8, 10, 12, 10, 9];
C1_56K =[7, 11, 11, 12, 11, 12, 11, 12, 11, 11 ];
