...
hold on;
Lb=[4000:64000];
n=ceil((1-0.000005).^(-8*(Lb+8+(Lb+20)/(1500-20)*28)))+2;
time = (n*20-10)*60;
h2 =plot(Lb,time,'-k');
hold on;
Lb=[4000:64000];
...
C1_24K=[3000,1800,3000,3000,1800,3000,4200,3000,4200,3000];
...
hold on;
%第二组实验数据
C1_16K=[4200,3000,4200,4200,3000,4200,5400,4200,5400,4200];
C1_24K=[5400,4200,5400,5400,4200,5400,5400,5400,6600,5400];
C1_32K=[5400,6600,6600,5400,9000,6600,7800,6600,5400,6600];
C1_40K=[10200,9000,9000,7800,9000,7800,9000,7800,11400,9000];
C1_48K=[10200,11400,11400,11400,9000,10200,12600,15000,12600,11400];
C1_56K=[9000,13800,13800,17400,13800,15000,11400,15000,13800,13800];
...
%第三组实验数据
C1_16K=[3000,1800,3000,3000,1800,3000,4200,3000,4200,3000];
C1_24K=[4200,3000,4200,4200,3000,4200,4200,4200,5400,4200];
C1_32K=[4200,5400,5400,4200,7800,6600,6600,5400,4200,5400];
C1_40K=[9000,7800,7800,6600,7800,6600,7800,6600,10200,7800];
C1_48K=[9000,10200,10200,10200,7800,9000,11400,13800,11400,10200];
C1_56K=[7800,12600,12600,13800,12600,13800,12600,13800,12600,12600];
I11 =zeros(6,10);
I11(1,:)= C1_16K;
I11(2,:)= C1_24K;
I11(3,:)= C1_32K;
...
% Lb2=[4000:64000];
% n2=ceil((1-0.000005).^(-8*(Lb2+8+(Lb2+20)/(1500-20)*28)))-1;
% time2 = (n2*20+10)*60;
% h2 =plot(Lb2,time2,'-r');
% hold on;
